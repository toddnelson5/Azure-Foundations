...
param vnetName string = 'vnet_storage_eastus'

@description('Address prefix')
param vnetAddressPrefix string = '10.0.4.0/22'

@description('Name of NSG for Web_storage subnet')
param NSG1 string = 'NSG_Web_storage_eastus'

@description('Subnet 1 Prefix')
param subnet1Prefix string = '10.0.4.0/24'

@description('Subnet 1 Name')
param subnet1Name string = 'Web_storage_eastus'

@description('Name of NSG for App_storage subnet')
param NSG2 string = 'NSG_App_storage_eastus'

@description('Subnet 2 Prefix')
param subnet2Prefix string = '10.0.5.0/24'

@description('Subnet 2 Name')
param subnet2Name string = 'App_storage_eastus'

@description('Name of NSG for DB_storage subnet')
param NSG3 string = 'NSG_DB_storage_eastus'

@description('Subnet 3 Prefix')
param subnet3Prefix string = '10.0.6.0/24'

@description('Subnet 3 Name')
param subnet3Name string = 'DB_storage_eastus'
...
param RecoverserviceVaultName string = 'RSV-storage-eastus'
